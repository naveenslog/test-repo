...
import { loadSchoolDetails } from '../../reducers/schoolReducer';
import Listing from './list';

const Profile = (props) => {
    const { params, session, loadSchoolDetails, schoolDetails, schoolList } = props;
    ...
    return (
        <React.Fragment>
            {session.membership&&<div style={{ marginTop: "70px", padding: "0px 50px" }}>
                    ...
                    <div className="container">
                        ...
                        <div className="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                            <div className="profile-right">
                                <div className="profile-right-header">List of application</div>
                                <div className="profile-right-body">
                                    <div className="profile-right-body-header"></div>
                                    <div className="listnerMain">
                                        {schoolList&&schoolList.map(item=><Listing item={item}/>)}
                                    </div>
                                </div>
                            </div>
                        </div>
