...
CREATE TABLE `admission_enquiry` (
  ...
  `schoolprofile_id` int(6) NOT NULL,
...
INSERT INTO `schoolprofile` VALUES (1,'pradip','fdafafasfaf','pradip.comat@appypiellp.com','6563636363',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,0,0,NULL),(2,'DPS','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','6563636363',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',0,0,NULL),(3,'DPS','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','6563636363',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',4,0,NULL),(4,'DPS','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','6563636363',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',4,0,NULL),(5,'DPS','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','54674747474',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',4,0,NULL),(6,'DPS','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','54674747474',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',4,0,NULL),(7,'DPSdfafafasfs','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','pradipdsaff.comat@appypiellp.com','54674747474',NULL,'Noida',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,'In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:','In the first step, we require to get fresh Laravel application using below command, So open your terminal OR command prompt and run below command:',4,0,NULL),(8,'qwe','This is overview','akash@mail.com','121312111',NULL,'Delhi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,8,'no scholarship','new fee','sldkfjsldf',0,0,NULL),(9,'akash','Scool','akash@mail.com','9876543210',NULL,'\"\"',NULL,NULL,NULL,NULL,NULL,NULL,NULL,16,'No scholarship','2000\n20000\n500\n22500','English,Hindi\nEnglish,Maths,Hindi,Science,SST\nEnglish,Maths,Hindi,Science,SST\nHistory,Economics,Political Science\nPhysics\nAccounts\nEnter subjects',4,0,NULL),(10,'Qwerty','\"a\"','aa@mail.com','\"a\"',NULL,'\"a\"',NULL,NULL,NULL,NULL,NULL,NULL,NULL,17,'\"a\"','\"a\"','\"a\"',0,0,NULL),(11,'Q','\"a\"','qqw@mail.com','\"a\"',NULL,'\"a\"',NULL,NULL,NULL,NULL,NULL,NULL,NULL,19,'\"a\"','\"a\"','\"a\"',0,0,NULL),(12,'Quy','\"\"','qqepw@mail.com','\"\"',NULL,'\"\"',NULL,NULL,NULL,NULL,NULL,NULL,NULL,21,'\"\"','\"\"','\"\"',0,0,NULL),(13,'Pk','Add a brief description about your school','pk@mail.com','911234567890',NULL,'Delhi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,23,'Add any scholarship offer (if available)','Add your school fee description','Add the list of courses that your school provides',0,0,NULL),(14,'Pkp','Add a brief description about your school','pkp@mail.com','911234567890',NULL,'Delhi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,24,'Add any scholarship offer (if available)','Add your school fee description','Add the list of courses that your school provides',0,0,NULL),(15,'Angels','Add a brief description about your school','angel@mail.com','911234567890',NULL,'Delhi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,25,'Add any scholarship offer (if available)','Add your school fee description','Add the list of courses that your school provides',4,0,NULL),(16,'Test','Add a brief description about your school dndnd','test@gmail.com','911234567890',NULL,'Delhi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,26,'Add any scholarship offer (if available)','Add your school fee description bxbdn','Add the list of courses that your school provides',4,0,NULL);
...
-- Dump completed on 2020-02-29  4:29:49
